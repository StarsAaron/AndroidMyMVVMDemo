...
import com.aaron.widgetlibrary.view.NumberProgressBar;
...
public final class UpdateDialog {
    ...
    public static final class Builder
            ...
            implements OnDownloadListener, OnPermission, View.OnClickListener {
        ...
        public void noPermission(List<String> denied, boolean quick) {
            ToastUtils.showShort(R.string.update_permission_hint);
        }
    }
